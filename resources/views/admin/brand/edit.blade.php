...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form class="" id="dataForm" role="form" action="{{url('admin/brand')}}/{{$brand->brand_id}}" method="post" enctype="multipart/form-data" >
                {{method_field('PUT')}}
                {{ csrf_field() }}
                <div class="col-sm-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class=" jointbox">
                                    <input type="text" class="form-control" id="brand_name" name="brand_name" placeholder="Name" value="@if($brand->brand_name) {{$brand->brand_name}} @else {{old('brand_name')}} @endif"/>
