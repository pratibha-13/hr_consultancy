        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="box">
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" id="userForm" role="form" action="{{url('admin/groups/update')}}" method="post" enctype="multipart/form-data" >
                        <div class="col-sm-8">
                            {{ csrf_field() }}
                            <div class="box-body">
                                ...
                                <div class="form-group {{ $errors->has('group_name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                      <input type="text" class="form-control" id="group_name" name="group_name" placeholder="Group Name" value="{{$group->group_name}}"/>
                                ...
                                <div class="form-group {{ $errors->has('group_description') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea id="group_description" name="group_description" class="form-control" placeholder="Group Description"> {{$group->group_description}} </textarea>
                                ...
                                <div class="form-group {{ $errors->has('user_id') ? ' has-error' : '' }}">
                                    <label  class="col-sm-4 control-label" for="country">Group Admin<span class="colorRed"> *</span></label>
                                    <div class="col-sm-8">
                                        <select id="user_id" name="user_id[]" multiple class="form-control">
                                            <option value="">Select User</option>
                                            @foreach($users as $user)
                                                <option value="{{$user->id}}" {{ (in_array($user->id, $groupMember)) ? 'selected' : '' }} >{{$user->first_name}}</option>
                                            @endforeach
                                        </select>
