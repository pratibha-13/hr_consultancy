                                    ...
                                    <table class="table table-user-information">
                                        <tbody>
                                          <tr>
                                            ...
                                            <input type="checkbox" name="new_arrival" value="1" {{ $product->new_arrival=="1"? 'checked':'' }}></td>
                                            </tr>
                                            @endif
                                            ...
                                            <td class="text-primary">
                                            <input type="checkbox" name="featured" value="1" {{ $product->featured=="1"? 'checked':'' }}></td>
                                            </tr>
                                            @endif
                                            ...
                                            <td class="text-primary">
                                            <input type="checkbox" name="special_offer" value="1" {{ $product->special_offer=="1"? 'checked':'' }}></td>
                                            </tr>
                                            @endif
            ...
            <div class="col-sm-12">
                <div class="" style="border-top:0">
                    <div class="box-footer">
                        <a type="button" href="{{route('product.index')}}" id="cancelBtn button1" class="btn btn-default pull-right">Back</a>
                    </div>
                </div>
            </div>
            <div class="clearfix">
