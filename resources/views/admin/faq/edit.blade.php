                    ...
                    <div class="col-sm-12">
                        <form class="" id="faqForm" action="{{url($url)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                        ...
                                        <option value="general" @if($faq->type=='general') selected='selected' @endif>General</option>
                                        <option value="other" @if($faq->type=='other') selected='selected' @endif>Other</option>
