...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form class="" id="dataForms" role="form" action="{{route('blog.store')}}" method="post" enctype="multipart/form-data" >
                {{ csrf_field() }}
                <div class="col-sm-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->has('blog_title') ? ' has-error' : '' }}">
                                ...
                                <div class="">
                                    <input maxlength="100" type="text" id="blog_title" name="blog_title" class="form-control" value="{{old('blog_title')}}" placeholder="Title">
