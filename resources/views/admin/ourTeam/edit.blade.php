...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form class="" id="dataForm" role="form" action="{{route('ourTeam.update',$record->our_team_id)}}" method="POST" enctype="multipart/form-data" >
                {{ csrf_field() }}
                ...
                <div class="col-sm-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <input type="hidden" id="id" name="id" value="{{$record->our_team_id}}"/>

                            <div class="form-group {{ $errors->has('full_name') ? ' has-error' : '' }}">
                                <label  class=" control-label" for="full_name">Full Name <span class="colorRed"> *</span></label>
                                <div class="">
                                    <input maxlength="100" type="text" id="full_name" name="full_name" class="form-control" value="@if(!empty(old('full_name'))){{old('full_name')}}@else{{$record->full_name}}@endif" placeholder="Type full_name here">
                            ...
                            <div class="form-group {{ $errors->has('designation') ? ' has-error' : '' }}">
                                ...
                                <div class="">
                                    <input maxlength="100" type="text" id="designation" name="designation" class="form-control" value="@if(!empty(old('designation'))){{old('designation')}}@else{{$record->designation}}@endif" placeholder="Type designation here">
                            ...
                            <div class="form-group">
                                ...
                                <div class="vc_column-inner ">
                                    <label class="cabinet center-block">
                                        <figure>
                                            <img src="{{ $record->profile? $record->profile:URL::asset('/resources/assets/img/default.png')}}" class="gambar" id="item-img-output"  name="avatar"  style="height:250px;"/>
                                        </figure>
                                        <p></p>
