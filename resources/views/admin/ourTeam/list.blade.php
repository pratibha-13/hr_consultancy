    ...
    <section class="content">
        <div class="row">
                <div class="col-sm-2 pull-right" style="padding-bottom: 10px;">
                    <a href="{{route('ourTeam.create')}}"><button type="button" class="btn btn-block btn-primary">New Our Team</button></a>
                </div>
            <div class="col-xs-12">
                <div class="box">
                    <!-- /.box-header -->
