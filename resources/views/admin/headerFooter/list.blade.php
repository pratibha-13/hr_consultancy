@section('title') Header Footer Settings | @endsection
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <a href="{{route('header_footer.create')}}"><button type="button" class="btn btn-block btn-primary">New</button></a></td>
        </div> -->
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                      ...
                      {!! $html->table(['class' => 'table table-bordered','id'=>'HeaderFooterSettingsDataTable']) !!}
