...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form class="" id="dataForm" role="form" action="{{route('banner.update',$record->banner_id)}}" method="POST" enctype="multipart/form-data" >
                {{ csrf_field() }}
                ...
                <div class="col-sm-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <input type="hidden" id="banner_id" name="banner_id" value="{{$record->banner_id}}"/>
                            <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                <label  class=" control-label" for="title">Title <span class="colorRed"> *</span></label>
                                <div class="">
                                    <input maxlength="100" type="text" id="title" name="title" class="form-control" value="@if(!empty(old('title'))){{old('title')}}@else{{$record->title}}@endif" placeholder="Type title here">
                                    @if ($errors->has('title'))
                            ...
                            <div class="form-group {{ $errors->has('banner_description') ? ' has-error' : '' }}">
                                ...
                                <div class="">
                                    <textarea id="banner_description" name="banner_description" class="form-control" value="{{old('banner_description')}}" placeholder="Banner Description">{{$record->banner_description}}</textarea>
                            ...
                            <div class="form-group {{ $errors->has('link') ? ' has-error' : '' }}">
                                ...
                                <div class="">
                                    <input type="text" class="form-control" id="link" name="link" placeholder="Link" value="@if(!empty(old('link'))){{old('link')}}@else{{$record->link}}@endif"/>
                                    @if ($errors->has('link'))
                                    <span class="help-block alert alert-danger">
                            ...
                            <div class="form-group">
                                ...
                                <div class="vc_column-inner ">
                                    <label class="cabinet center-block">
                                        <figure>
                                            <img src="{{ $record->image? $record->image:URL::asset('/resources/assets/img/default.png')}}" class="gambar" id="item-img-output"  name="avatar"  />
                                        </figure>
                                        <p></p>
                                        <input type="hidden" name="main_image" value="{{ $record->image }}" id="main_image" style="">
