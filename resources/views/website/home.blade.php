        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4">
                <div class="d-block bg-primary h-100 text-center">
                    <img class="img-fluid" src="{{ URL::asset('/resources/assets/website/img/feature.jpg')}}" alt="">
                    <div class="p-4">
                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded-circle" src="{{ URL::asset('/resources/assets/website/img/testimonial-1.jpg')}}" alt="">
                            <div class="ps-4">
                                <h3>Client Name</h3>
    ...
    <div class="container-fluid py-6 px-5">
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4">
                <div class="blog-item">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="{{ URL::asset('/resources/assets/website/img/blog-3.jpg')}}" alt="">
                    </div>
                    <div class="bg-secondary d-flex">
                        <div class="flex-shrink-0 d-flex flex-column justify-content-center text-center bg-primary text-white px-4">
                            <span>01</span>
