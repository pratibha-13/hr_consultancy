...
class HomePageSliderDataTable extends DataTable
{
    ...
    {
        return $model->newQuery()->select('home_page_slider_id', 'title', 'short_description', 'category','sub_category','product', 'image','status','created_at', 'updated_at');
    }
    ...
    {
        return ['home_page_slider_id', 'title', 'short_description', 'category','sub_category','product', 'image','status','created_at', 'updated_at'
        ];
    }
